...
const ThemeToggle = () => {
    ...
    useEffect(() => {
        const applyTheme = () => {
            const layoutWrapper = document.querySelector('._layout_main_wrapper');
            if (layoutWrapper) {
                if (isDarkMode) {
                    layoutWrapper.classList.add('_dark_wrapper');
                } else {
                    layoutWrapper.classList.remove('_dark_wrapper');
                }
        ...
        <div className="_layout_mode_swithing_btn">
            ...
            >
                <div className="_layout_swithing_btn">
                    {/* This div moves left/right based on mode */}
                    <div
