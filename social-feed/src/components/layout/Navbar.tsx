...
// If you are using a router (like react-router-dom), change <a> tags to <Link>
// import { Link } from 'react-router-dom'; 

const Navbar: React.FC = () => {
    // State to manage dropdowns and mobile toggle
        ...
        <nav className="navbar navbar-expand-lg navbar-light _header_nav _padd_t10">
            <div className="container _custom_container">
              ...
              >
                ...
                <div id="_notify_drop" className={`_notification_dropdown ${isNotifyOpen ? 'active' : ''}`} style={{ display: isNotifyOpen ? 'block' : 'none' }}>
                  ...
                  <div className="_notifications_drop_box">
                    ...
                    <div className="_notifications_all">
                      {/* Example Notification Item 1 */}
                        ...
                        <div className="_notification_image">
                          <img src="assets/images/friend-req.png" alt="User" className="_notify_img" />
                        </div>
                        ...
                        {/* Additional notifications can be mapped here from an array */}
                        <div className="_notification_box">
                        <div className="_notification_image">
                            <img src="assets/images/profile-1.png" alt="Profile" className="_notify_img" />
                        </div>
                        <div className="_notification_txt">
                            <p className="_notification_para">
                    ...
                    <div className="_header_nav_profile">
                        ...
                        {/* Dropdown Content */}
                        <div id="_prfoile_drop" className={`_nav_profile_dropdown _profile_dropdown ${isProfileOpen ? 'active' : ''}`} style={{ display: isProfileOpen ? 'block' : 'none' }}>
